...
typedef enum stateTypeEnum {
    led1, led2, led3, waitRelease1, waitRelease2, debouncePress, debounceRelease
} stateType;

//DONE: Use volatile variables that change within interrupts
volatile stateType state = led2; // The initial state of our state machine.
